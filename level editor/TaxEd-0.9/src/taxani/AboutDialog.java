...
public class AboutDialog extends JDialog {
	public AboutDialog(final TaxAni taxAni)
	{
		setTitle("About TaxAni...");
		...
		JLabel lblTest = new JLabel(new ImageIcon(this.getClass().getResource("/taxani/tails.gif")));
		...
		JLabel lblTaxed = new JLabel("TaxAni");
		...
		JLabel lblTheRetrosonicLevel = new JLabel("The Retro-Sonic Animation Editor");
